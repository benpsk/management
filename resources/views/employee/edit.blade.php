...
<div class="container my-3">
    ...
    <form hx-post="{{ route('employee.update',  $employee->id )}}" hx-target="#app" hx-swap="outerHTML" hx-push-url="true">
        @csrf
        @method('put')
        @if ($errors->any())
        ...
        <a type="button" class="btn btn-danger" hx-get="{{ route('employee.index') }}" hx-swap="outerHTML" hx-target="#app">back</a>
    </form>
</div>
@endsection
