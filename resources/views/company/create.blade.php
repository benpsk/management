...
<div class="container" id="company-create-form">
    ...
    <form hx-post="{{ route('company.store')}}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" id="cname" aria-describedby="emailHelp" placeholder="eg. ABC Company" required>
        </div>
        <div class="mb-3">
            <label for="email" class="form-label">Email Address</label>
            <input type="email" name="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="eg. example@example.com" required>
        </div>
